...
```{r, fig.width=4, fig.height=3.5, out.width="500px"}
...
```{r, fig.width=9, fig.height=8, cache = TRUE, warning=FALSE, message=FALSE}
library(mplot)
...
p1 <- plot(vis, interactive = FALSE, highlight = "random.1", which = "lvk") + theme_minimal(base_family = "Raleway", base_size = 9)
p2 <- plot(vis, interactive = FALSE, highlight = "random.2", which = "lvk") + theme_minimal(base_family = "Raleway", base_size = 9)
p3 <- plot(vis, interactive = FALSE, highlight = "gross.pay", which = "lvk") + theme_minimal(base_family = "Raleway", base_size = 9)
p4 <- plot(vis, interactive = FALSE, highlight = "phi.h", which = "lvk") + theme_minimal(base_family = "Raleway", base_size = 9)
p5 <- plot(vis, interactive = FALSE, highlight = "pressure", which = "lvk") + theme_minimal(base_family = "Raleway", base_size = 9)
p6 <- plot(vis, interactive = FALSE, highlight = "gross.pay.transform", which = "lvk") + theme_minimal(base_family = "Raleway", base_size = 9)
...
```{r, fig.width=8, fig.height=7.5, cache = TRUE, out.width=800, warning=FALSE, message=FALSE, eval = FALSE}
...
```{r, fig.width=9, fig.height=4, cache = TRUE, warning=FALSE, message=FALSE}
